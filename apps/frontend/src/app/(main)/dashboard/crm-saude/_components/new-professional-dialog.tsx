...
export function NewProfessionalDialog({ trigger }: NewProfessionalDialogProps) {
        ...
        onError: (err: Error) => {
          const message =
            err && typeof err === "object" && "detail" in err
              ...
              : err?.message ?? "Erro ao cadastrar profissional";
          toast.error(message);
        },
      }
    );
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="max-h-[90vh] overflow-y-auto sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Preencha os dados do profissional de saúde. Campos com * são
            obrigatórios.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
